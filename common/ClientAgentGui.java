 ...
 */
public class ClientAgentGui extends JFrame implements ActionListener
{
...
//          System.out.println("In the first Constructor");
  	...
  	ClientAgentGui(ClientAgent ca){
		super();
		this.myAgent = ca;

		addWindowListener(new	WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				ClientAgentGui.this.myAgent.doDelete();
			}
		} );
	}
