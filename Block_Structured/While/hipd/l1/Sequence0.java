...
//	private byte[] RETURNED_VARIABLE_MESSAGE = null;	
	...
	private void defineActivities() {
		...
		sequence0SubflowActivity1Activity
				.setSubflow("Block_Structured.While.hipd.l1.FrequentPath1");
...
//		s.setPerformer("FrequentPath1_Agent");
		s.setPerformer(ContainerManagement.getContainer("FrequentPath1_Agent", "Block_Structured.While.hipd.l1.FrequentPath1"));
		s.fill("input", input);
