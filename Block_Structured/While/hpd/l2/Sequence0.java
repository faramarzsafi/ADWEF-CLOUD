...
//	private byte[] RETURNED_VARIABLE_MESSAGE = null;	
	...
	private void defineActivities() {
		...
		sequence0SubflowActivity1Activity
				.setSubflow("Block_Structured.While.hpd.l2.Receive");
...
//		System.out.println("Sequence0: Run"+input);		
		try {
...
//		s.setPerformer("Receive_Agent");
		s.setPerformer(ContainerManagement.getContainer("Receive_Agent", "Block_Structured.While.hpd.l2.Receive"));
		s.fill("input", input);
