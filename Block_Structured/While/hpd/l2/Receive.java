...
public class Receive extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		receiveSubflowActivity1Activity
				.setSubflow("Block_Structured.While.hpd.l2.While");
...
//		System.out.println("Receive: Executed"+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {e.printStackTrace();}
		
//		s.setPerformer("While_Agent");
		s.setPerformer(ContainerManagement.getContainer("While_Agent", "Block_Structured.While.hpd.l2.While"));
		s.fill("input", input);
