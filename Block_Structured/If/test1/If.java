package Block_Structured.If.test1;
...
public class If extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		ifSubflowActivity1Activity
				.setSubflow("Block_Structured.If.test1.Assign1");
		registerActivity(ifSubflowActivity1Activity, FINAL);
		...
		ifSubflowActivity2Activity
				.setSubflow("Block_Structured.If.test1.Assign2");
		registerActivity(ifSubflowActivity2Activity, FINAL);
...
//		s.setPerformer("Assign1_Agent");
		s.setPerformer(ContainerManagement.getContainer("Assign1_Agent", "Block_Structured.If.test1.Assign1"));
		s.fill("input", input);
...
//			s.setPerformer("Assign2_Agent");
			s.setPerformer(ContainerManagement.getContainer("Assign2_Agent", "Block_Structured.If.test1.Assign2"));
			s.fill("input", input);
			s.fill("VARIABLE_MESSAGE", VARIABLE_MESSAGE);
			performSubflow(s);
	}
