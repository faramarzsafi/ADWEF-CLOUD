...
public class Sequence0 extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		sequence0SubflowActivity1Activity
				.setSubflow("Block_Structured.If.hipd.l1.FrequentPath1");
...
//		s.setPerformer("FrequentPath1_Agent");
		s.setPerformer(ContainerManagement.getContainer("FrequentPath1_Agent", "Block_Structured.If.hipd.l1.FrequentPath1"));
		s.fill("input", input);
		...
		try {
			...
			System.out.println("Inside catch of calling performSubflow(s) FrequentPath1_Agent"+e.getMessage()+e.getCause());
			e.printStackTrace();
			throw e;
		}
