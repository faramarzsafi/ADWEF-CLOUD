...
public class Receive extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		receiveSubflowActivity1Activity
				.setSubflow("Block_Structured.If.hpd.l2.If");
...
//		s.setPerformer("If_Agent");
		s.setPerformer(ContainerManagement.getContainer("If_Agent", "Block_Structured.If.hpd.l2.If"));
		performSubflow(s);
//		output = ((Integer)s.extract("output")).intValue();
//			System.out.println("Receive: return response from Receive is: "+output);
	}
}