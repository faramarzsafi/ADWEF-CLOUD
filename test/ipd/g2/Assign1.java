...
public class Assign1 extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		assign1SubflowActivity.setSubflow("test.ipd.g2.Agent1Workflow");
	...
	protected void executeAssign1Code() throws Exception {
		try {
			...
			System.out.println("test.ipd.g2: Assign1 : in the catch: "+e.getMessage()+e.getCause());
		}
	}
...
//		System.out.println("test.ipd.g2: Assign1: return response is: "+output);
	}
}