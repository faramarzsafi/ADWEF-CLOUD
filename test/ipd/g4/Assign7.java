...
public class Assign7 extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		replySubflowActivity.setSubflow("test.ipd.g4.Reply");
	...
	protected void executeAssign7Code() throws Exception {
		try {
			...
			System.out.println("test.ipd.g4: Assign7 : in the catch: "+e.getMessage()+e.getCause());
		}
	}
...
//		System.out.println("test.ipd.g4:Assign1: return response is: "+output);
	}
}
