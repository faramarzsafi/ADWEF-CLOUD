...
public class Receive extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		Receive1Subflow.setSubflow("test.ipd.g3.Assign1");
	...
	protected void executeReceiveCode() throws Exception {
		try {
			...
			System.out.println("test.ipd.g3: Receive : in the catch: "+e.getMessage()+e.getCause());
		}
	}
...
//		System.out.println("test.ipd.g3: Receive: return response is: "+output);
	}
}
