...
public class Assign1 extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		assign1SubflowActivity.setSubflow("test.ipd.g3.Flow");
	...
	protected void executeAssign1Code() throws Exception {
		try {
			...
			System.out.println("test.ipd.g3: Assign1 : in the catch: "+e.getMessage()+e.getCause());
		}
	}
...
//		System.out.println("test.ipd.g3: Assign1: return response from flow is: "+output);
	}
}