...
import test.ipd.g1.Sequence1;
import test.ipd.g1.Sequence2;
import test.ipd.g1.Sequence3;
...
//		System.out.println("test.ipd.g1: executeReceive: "+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			System.out.println("test.ipd.g1: Sequence1: in the catch: "+input);
		}
		a = input;
	}
	...
	public void Receive(){
//		System.out.println("test.ipd.g1: Receive: "+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			System.out.println("test.ipd.g1: Receive: in the catch: "+input);
		}
		a = input;
	}
	public void Assign1(){
//		System.out.println("test.ipd.g1: Assign1: "+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			System.out.println("test.ipd.g1: Assign1: in the catch: "+input);
		}
		a = input;
	}
	
	public void Assign2(){
//		System.out.println("test.ipd.g1: Assign2: "+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			System.out.println("test.ipd.g1: Assign2: in the catch: "+input);
		}
		a = input;
	}
	
	public void Assign3(){
//		System.out.println("test.ipd.g1: Assign3: "+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
...
public void Flow(){
		...
		sq3.join();
			...
			// TODO Auto-generated catch block
			System.out.println("test.ipd.g1: Flow: in the catch: "+input);
		}
...
//		System.out.println("test.ipd.g0: : before calling Assign4: "+input);
		s = new com.tilab.wade.performer.Subflow("test.ipd.g1.Assign4");
		s.fill("input", input);
		s.setPerformer("Assign4_Agent");
		performSubflow(s);
//		output = ((Integer)s.extract("output")).intValue();
//		System.out.println("test.ipd.g1: Flow: Branch 1: Assign4: the output  "+output);
	}else if ((input>10) && (input <=20)){
//		Assign5();
//		System.out.println("test.ipd.g1: before calling Assign5: "+input);
		s = new com.tilab.wade.performer.Subflow("test.ipd.g1.Assign5");
		s.fill("input", input);
		s.setPerformer("Assign5_Agent");
		performSubflow(s);
//		output = ((Integer)s.extract("output")).intValue();
//		System.out.println("test.ipd.g1: Flow: Branch 2: Assign5: the output  "+output);
	...
	public void Assign4(){
//		System.out.println("test.ipd.g1: Assign4: "+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			System.out.println("test.ipd.g1: Assign4: in the catch: "+input);
		}
		a = input;	
	}
	
	public void Assign5(){
//		System.out.println("test.ipd.g1: Assign5: "+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			System.out.println("test.ipd.g1: Assign5: in the catch: "+input);
		}
		a = input;	
	}
	
	public void Assign6(){
//		System.out.println("test.ipd.g1: Assign6: "+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			System.out.println("test.ipd.g1: Assign6: in the catch: "+input);
		}
		a = input;
	}
	
	public void Assign7(){
//		System.out.println("test.ipd.g1: Assign7: "+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			System.out.println("test.ipd.g1: Assign7: in the catch: "+input);
		}
		a = input;		
	}
	public void Reply(){
//		System.out.println("test.ipd.g1: Reply7: "+input);
		try {
			Thread.sleep(share.ACTIVITY_SLEEP);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			System.out.println("test.ipd.g1: Reply: in the catch: "+input);
		}
		a = input;		
	}
}
