...
public class Sequence0 extends WorkflowBehaviour {
	...
	private byte[] RETURNED_VARIABLE_MESSAGE;
	...
	private void defineActivities() {
		...
		Sequence1Subflow.setSubflow("test.ipd.g1.Agent1Workflow");
...
//		System.out.println("test.ipd.g1: Sequence0: return response from Receive is: "+output);
	}
}
