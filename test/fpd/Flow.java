...
public class Flow extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		Sequence1.setSubflow("test.fpd.Sequence1");
		Sequence1.setAsynch();
		...
		assign7SubFlowActivity.setSubflow("test.fpd.Assign7");
...
//			System.out.println("test.fpd: Flow: Seq1: Join: return response is: "+output);
		}
		ls = (List<Subflow>) ss.get(SEQUENCE2_ACTIVITY);
		for (Subflow tmpS : ls) {
//			output = ((Integer)tmpS.extract("output")).intValue();
//			System.out.println("test.fpd: Flow: Seq2: Join: return response is: "+output);
		}
		ls = (List<Subflow>) ss.get(SEQUENCE3_ACTIVITY);
		for (Subflow tmpS : ls) {
//			output = ((Integer)tmpS.extract("output")).intValue();
//			System.out.println("test.fpd: Flow: Seq3: Join: return response is: "+output);
		}
	}
...
//		System.out.println("test.fpd: Flow-Join: return response from Assign7 is: "+output);
	}
}
