...
//	private byte[] RETURNED_VARIABLE_MESSAGE = null;	
	...
	public void Sequence0() throws InterruptedException {
...
//		System.out.println("Assign5: "+input);
		...
		Assign5SubFlow = new com.tilab.wade.performer.Subflow("LoanTaking.hipd.l0.Assign5");
...
//		Assign5SubFlow.setPerformer("Assign5_Agent");
		Assign5SubFlow.setPerformer(ContainerManagement.getContainer("Assign5_Agent", "LoanTaking.hipd.l0.Assign5"));
		try {
