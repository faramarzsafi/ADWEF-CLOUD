...
@WorkflowLayout(entryPoint = @MarkerLayout(position = "(342,138)", activityName = "FlowCodeActivity1"), exitPoints = {@MarkerLayout(position="(339,372)", activityName = "FlowSubflowActivity1If") }, activities={@ActivityLayout(size = "(128,50)", position="(291,216)", name="FlowCodeActivity1"), @ActivityLayout(size = "(154,50)", position="(275,298)", name = "FlowSubflowActivity1If")})
public class Flow extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		FlowSubflowActivity1If.setSubflow("LoanTaking.hpd.l3.If");
	...
	protected void executeFlowCodeActivity1() throws Exception {
	 ...
	 void executeFlowSubflowActivity1If(Subflow s) throws Exception {
//		System.out.println("Flow-before calling If: Executed");
//		s.setPerformer("If_Agent");
		s.setPerformer(ContainerManagement.getContainer("If_Agent", "LoanTaking.hpd.l3.If"));
		s.fill("input", input);
...
//			System.out.println("Flow-before calling Sequence1: Executed");
			Sequence1SubFlow = new com.tilab.wade.performer.Subflow("LoanTaking.hpd.l3.Sequence1");
			Sequence1SubFlow.fill("input", input);
			Sequence1SubFlow.fill("VARIABLE_MESSAGE", VARIABLE_MESSAGE);
			
//			Sequence1SubFlow.setPerformer("Sequence1_Agent");
			Sequence1SubFlow.setPerformer(ContainerManagement.getContainer("Sequence1_Agent", "LoanTaking.hpd.l3.Sequence1"));
...
//			System.out.println("Flow-before calling Sequence2: Executed");
			Sequence2SubFlow = new com.tilab.wade.performer.Subflow("LoanTaking.hpd.l3.Sequence2");
			Sequence2SubFlow.fill("input", input);
			Sequence2SubFlow.fill("VARIABLE_MESSAGE", VARIABLE_MESSAGE);
//			Sequence2SubFlow.setPerformer("Sequence2_Agent");
			Sequence2SubFlow.setPerformer(ContainerManagement.getContainer("Sequence2_Agent", "LoanTaking.hpd.l3.Sequence2"));
	...
	protected void executeFlowSubflowJoinActivity1(SubflowList ss)
			throws Exception {
				Subflow s;
				List<Subflow> ls;
				
//				System.out.println("Flow-after Join: Executed");
	}
}
