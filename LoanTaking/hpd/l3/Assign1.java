...
@WorkflowLayout(exitPoints = { }, activities={@ActivityLayout(size = "(168,50)", position="(297,193)", name="Assign1SubflowActivity1")})
public class Assign1 extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		assign1SubflowActivity1Activity.setSubflow("LoanTaking.hpd.l3.Flow");
...
//		s.setPerformer("Flow_Agent");
		s.setPerformer(ContainerManagement.getContainer("Flow_Agent", "LoanTaking.hpd.l3.Flow"));
		s.fill("input", input);
