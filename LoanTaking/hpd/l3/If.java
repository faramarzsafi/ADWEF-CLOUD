...
public class If extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		IfSubflowActivity1Reply.setSubflow("LoanTaking.hpd.l3.Reply");
		...
		ifSubflowActivity2IfConditionActivity
				.setSubflow("LoanTaking.hpd.l3.Assign4");
		...
		ifSubflowActivity2ElseActivity.setSubflow("LoanTaking.hpd.l3.Assign5");
...
//		s.setPerformer("Reply_Agent");
		s.setPerformer(ContainerManagement.getContainer("Reply_Agent", "LoanTaking.hpd.l3.Reply"));
		s.fill("input", input);
		s.fill("VARIABLE_MESSAGE", VARIABLE_MESSAGE);
		performSubflow(s);
	}

	protected void executeIfSubflowActivity2IfCondition(Subflow s)throws Exception {
//		s.setPerformer("Assign4_Agent");
		s.setPerformer(ContainerManagement.getContainer("Assign4_Agent", "LoanTaking.hpd.l3.Assign4"));
		s.fill("input", input);
		s.fill("VARIABLE_MESSAGE", VARIABLE_MESSAGE);
		performSubflow(s);
	}
...
//		s.setPerformer("Assign5_Agent");
		s.setPerformer(ContainerManagement.getContainer("Assign5_Agent", "LoanTaking.hpd.l3.Assign5"));
		s.fill("input", input);
		s.fill("VARIABLE_MESSAGE", VARIABLE_MESSAGE);
		performSubflow(s);
	}
