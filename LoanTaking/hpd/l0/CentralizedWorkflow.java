...
class Sequence  {
	protected CentralizedWorkflow cw;
	public Sequence(CentralizedWorkflow cw){
		this.cw = cw;
	}
}
...
class Sequence1 extends Sequence implements Runnable{
	...
	public Sequence1(CentralizedWorkflow cw) {
		super(cw);
		this.cw = super.cw;
	}
...
class Sequence2 extends Sequence implements Runnable{
	...
	public Sequence2(CentralizedWorkflow cw) {
		super(cw);
		this.cw = super.cw;
	}
