...
@WorkflowLayout(entryPoint = @MarkerLayout(position = "(475,95)", activityName = "Sequence0SubflowActivity1Receive1"), exitPoints = {@MarkerLayout(position="(472,318)", activityName = "Sequence0SubflowActivity1Receive1") }, activities={@ActivityLayout(size = "(248,50)", position="(368,195)", name = "Sequence0SubflowActivity1Receive1")})
...
//	private byte[] RETURNED_VARIABLE_MESSAGE = null;	
	...
	private void defineActivities() {
		...
		Sequence0SubflowActivity1Receive1
				.setSubflow("LoanTaking.hpd.l2.Receive1");
...
//		System.out.println("In Sequence0: "+ContainerManagement.getContainer("Receive1_Agent"));
		s.setPerformer(ContainerManagement.getContainer("Receive1_Agent", "LoanTaking.hpd.l2.Receive1"));
		s.fill("input", input);
