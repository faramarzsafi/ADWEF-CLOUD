...
public class Receive1 extends WorkflowBehaviour {
	...
	private void defineActivities() {
		...
		receiveSubflowActivity1Activity.setSubflow("LoanTaking.hpd.l2.Assign1");
...
//		s.setPerformer("Assign1_Agent");
		s.setPerformer(ContainerManagement.getContainer("Assign1_Agent", "LoanTaking.hpd.l2.Assign1"));
		s.fill("input", input);
