...
@WorkflowLayout(entryPoint = @MarkerLayout(position = "(330,175)", activityName = "ReplyCodeActivity1"), exitPoints = {@MarkerLayout(position="(343,323)", activityName="ReplyCodeActivity1") }, activities={@ActivityLayout(size = "(192,50)", position="(250,236)", name="ReplyCodeActivity1")})
